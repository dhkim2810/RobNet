...
def main(args):
    ...
    # Data Poisoning
    trigger_dir = os.path.join(self.base_dir, "trigger_data")
    ...
    poisoned_train = data.PoisonedDataset(  train_dataset, trigger_dir,
                                            ...
                                            mask_loc=args.trigger_loc, num_trigger=args.num_trigger, poison_ratio=0.2)
    poisoned_valid = data.PoisonedDataset(  test_datset, trigger_dir,
                                            base=args.base_class, target=args.target_class, target_specific=args.target_specific,
                                            mask_loc=args.trigger_loc, num_trigger=args.num_trigger, poison_ratio=0.2)
